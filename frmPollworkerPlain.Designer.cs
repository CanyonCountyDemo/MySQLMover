...
{
  partial class frmPollworkerPlain
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "frmPollworkerPlain";
      this.Text = "frmPollworkerPlain";
      this.Load += new System.EventHandler(this.frmPollworkerPlain_Load);
